...
export const About = () => {
	...
	return (
		<div className="container container-about mt-5 d-flex justify-content-center align-items-center flex-column h-100 w-100">
			...
			<p className="text-about white font-main ">
				I like programming a lot. My bases are Javascript, React.js, Bootstrap,
				C++, Python. I invite you to my github and linkedin so you can know much
				more about me
			</p>
			{/* </div> */}
